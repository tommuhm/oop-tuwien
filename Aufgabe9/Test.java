public class Test {
	...
	private static void rdmSchachtelGenerator(int anzahl) {
		...
		for (int i = 0; i < anzahl; i++){
			...
			switch(rdm){
			case 0: schachtellager.addSchachtel(new Schachtel(rdmWithRange(9, 18), new Kreis(rdmWithRange(5, 10))));
			case 1: schachtellager.addSchachtel(new Schachtel(rdmWithRange(3, 15), new Quadrat(rdmWithRange(3, 9))));
			case 2: schachtellager.addSchachtel(new Schachtel(rdmWithRange(3, 20), new Sechseck(rdmWithRange(4,12))));
			default: schachtellager.addSchachtel(new Schachtel(rdmWithRange(3, 20), new Rechteck(rdmWithRange(2,6),rdmWithRange(6,12))));
			}
		}
	}
